...
NS_SWIFT_NAME(RequestAccountHandler);
...
NS_SWIFT_NAME(LogoutHandler);

/**
  Primary interface for authenticating AccountKit accounts.
 */
NS_SWIFT_NAME(AccountKit)
@interface AKFAccountKit : NSObject

/**
  The version of the Account Kit Graph API used.
 */
@property (class, nonatomic, copy, readonly) NSString *graphVersionString;

/**
 #abstract The version of the Account Kit SDK.
 */
@property (class, nonatomic, copy, readonly) NSString *versionString;
 ...
 */
- (void)logOut:(AKFLogoutHandler)handler;
...
NS_SWIFT_NAME(viewControllerForEmailLogin(with:state:));
...
state:(nullable NSString *)state
NS_SWIFT_NAME(viewControllerForPhoneLogin(with:state:));
