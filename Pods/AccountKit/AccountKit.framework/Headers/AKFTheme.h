...
} NS_SWIFT_NAME(HeaderTextType);

/// Count of all Header Text Type options
FOUNDATION_EXPORT const NSUInteger AKFHeaderTextTypeCount
NS_SWIFT_NAME(HeaderTextType.count);
...
} NS_SWIFT_NAME(ButtonTranslucentStyle);
...
NS_SWIFT_NAME(outlineTheme(primaryColor:primaryTextColor:secondaryTextColor:statusBarStyle:));
