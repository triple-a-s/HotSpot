 ...
 */
@property (nonatomic, assign, getter=isInitialSMSButtonEnabled) BOOL enableInitialSMSButton;

/**
 Specifies if the app supports receiving a phone call back for codes (as an SMS alternative)
 */
@property (nonatomic, assign, getter=isGetACallEnabled) BOOL enableGetACall;
